...
from apps.email_automation.core.email_sender import EmailSender
from apps.email_automation.models.email_models import User, EmailQueue, UserEmailPreferences
from config import Config

celery = Celery(
    "wedding_email_system",
